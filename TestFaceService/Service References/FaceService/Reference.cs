...
namespace TestFaceService.FaceService {
    ...
    public partial class FaceKafka : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestFaceService.FaceService.KafkaCompare[] KafkaFacesField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public TestFaceService.FaceService.KafkaCompare[] KafkaFaces {
            get {
    ...
    public interface IFaceWcfService {
        ...
        TestFaceService.FaceService.CompareFaces[] GetCompareByFace(byte[] imgbyte);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IFaceWcfService/GetCompareByFace", ReplyAction="http://tempuri.org/IFaceWcfService/GetCompareByFaceResponse")]
        System.Threading.Tasks.Task<TestFaceService.FaceService.CompareFaces[]> GetCompareByFaceAsync(byte[] imgbyte);
        ...
        TestFaceService.FaceService.CompareFaces[] GetCompareByFaceSmall(byte[] imgbyte);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IFaceWcfService/GetCompareByFaceSmall", ReplyAction="http://tempuri.org/IFaceWcfService/GetCompareByFaceSmallResponse")]
        System.Threading.Tasks.Task<TestFaceService.FaceService.CompareFaces[]> GetCompareByFaceSmallAsync(byte[] imgbyte);
        ...
        TestFaceService.FaceService.FaceKafka GetCompareByKafka(string imgUrl);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IFaceWcfService/GetCompareByKafka", ReplyAction="http://tempuri.org/IFaceWcfService/GetCompareByKafkaResponse")]
        System.Threading.Tasks.Task<TestFaceService.FaceService.FaceKafka> GetCompareByKafkaAsync(string imgUrl);
        ...
        TestFaceService.FaceService.CompareFaces[] GetCompareByFeature(byte[] imgbyte);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IFaceWcfService/GetCompareByFeature", ReplyAction="http://tempuri.org/IFaceWcfService/GetCompareByFeatureResponse")]
        System.Threading.Tasks.Task<TestFaceService.FaceService.CompareFaces[]> GetCompareByFeatureAsync(byte[] imgbyte);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IFaceWcfServiceChannel : TestFaceService.FaceService.IFaceWcfService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FaceWcfServiceClient : System.ServiceModel.ClientBase<TestFaceService.FaceService.IFaceWcfService>, TestFaceService.FaceService.IFaceWcfService {
        ...
        public TestFaceService.FaceService.CompareFaces[] GetCompareByFace(byte[] imgbyte) {
            return base.Channel.GetCompareByFace(imgbyte);
        }
        
        public System.Threading.Tasks.Task<TestFaceService.FaceService.CompareFaces[]> GetCompareByFaceAsync(byte[] imgbyte) {
            return base.Channel.GetCompareByFaceAsync(imgbyte);
        }
        
        public TestFaceService.FaceService.CompareFaces[] GetCompareByFaceSmall(byte[] imgbyte) {
            return base.Channel.GetCompareByFaceSmall(imgbyte);
        }
        
        public System.Threading.Tasks.Task<TestFaceService.FaceService.CompareFaces[]> GetCompareByFaceSmallAsync(byte[] imgbyte) {
            return base.Channel.GetCompareByFaceSmallAsync(imgbyte);
        }
        
        public TestFaceService.FaceService.FaceKafka GetCompareByKafka(string imgUrl) {
            return base.Channel.GetCompareByKafka(imgUrl);
        }
        
        public System.Threading.Tasks.Task<TestFaceService.FaceService.FaceKafka> GetCompareByKafkaAsync(string imgUrl) {
            return base.Channel.GetCompareByKafkaAsync(imgUrl);
        }
        
        public TestFaceService.FaceService.CompareFaces[] GetCompareByFeature(byte[] imgbyte) {
            return base.Channel.GetCompareByFeature(imgbyte);
        }
        
        public System.Threading.Tasks.Task<TestFaceService.FaceService.CompareFaces[]> GetCompareByFeatureAsync(byte[] imgbyte) {
